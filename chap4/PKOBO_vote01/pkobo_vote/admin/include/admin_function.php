...
//期間用プルダウン
function termYmdList($term_ymd = ''){
	
	$term_ymd_array = array();
	if(!empty($term_ymd)){
		$termArr = explode(" ",$term_ymd);
		$term_ymd_array = explode("-",$termArr[0]);
		$term_his_array = explode(":",$termArr[1]);
	}

	$start = date('Y');
	$end = date('Y') +1;
	?>
    <select name="data[term_y][]">
	<?php for($i=$start;$i <= $end;$i++){ ?>
	<?php if((isset($_POST['data']['term_y']) && $i == $_POST['data']['term_y']) || (!empty($term_ymd_array[0]) && $term_ymd_array[0] == $i) ){ ?>
	<option value="<?php echo $i;?>" selected="selected"><?php echo $i;?></option>
	<?php }elseif(!isset($_POST['data']['term_y']) && $i == date('Y') && empty($term_ymd)){ ?>
	<option value="<?php echo $i;?>" selected="selected"><?php echo $i;?></option>
    <?php }else{ ?>
	<option value="<?php echo $i;?>"><?php echo $i;?></option>
	<?php } ?>
	...
	$end = 12;
	?>
    <select name="data[term_m][]">
	<?php for($i=$start;$i <= $end;$i++){ ?>
	<?php if((isset($_POST['data']['term_m']) && $i == $_POST['data']['term_m']) || (!empty($term_ymd_array[1]) && $term_ymd_array[1] == $i) ){ ?>
	<option value="<?php echo $i;?>" selected="selected"><?php echo $i;?></option>
	<?php }elseif(!isset($_POST['data']['term_m']) && $i == date('n') && empty($term_ymd)){ ?>
	<option value="<?php echo $i;?>" selected="selected"><?php echo $i;?></option>
    <?php }else{ ?>
	<option value="<?php echo $i;?>"><?php echo $i;?></option>
    <?php } ?>
	...
	$end = 31;
	?>
    <select name="data[term_d][]">
	<?php for($i=$start;$i <= $end;$i++){ ?>
	<?php if((isset($_POST['data']['term_d']) && $i == $_POST['data']['term_d']) || (!empty($term_ymd_array[2]) && $term_ymd_array[2] == $i) ){ ?>
	<option value="<?php echo $i;?>" selected="selected"><?php echo $i;?></option>
	<?php }elseif(!isset($_POST['data']['term_d']) && $i == date('j') && empty($term_ymd)){ ?>
	<option value="<?php echo $i;?>" selected="selected"><?php echo $i;?></option>
    <?php }else{ ?>
 	<option value="<?php echo $i;?>"><?php echo $i;?></option>
	<?php } ?>
	...
	$end = 23;
	?>
    <select name="data[term_h][]">
	<?php for($i=$start;$i <= $end;$i++){ ?>
	<?php if((isset($_POST['data']['term_h']) && $i == $_POST['data']['term_h']) || (!empty($term_his_array[0]) && $term_his_array[0] == $i) ){ ?>
	<option value="<?php echo $i;?>" selected="selected"><?php echo $i;?></option>
	<?php }else{ ?>
 	<option value="<?php echo $i;?>"><?php echo $i;?></option>
	<?php } ?>
