...
//※逆にこのページに対して既存のページのhtmlを記述する形でももちろんOKですし、iframeで読み込んでもOKです。
//【ラジオボタンでの投票用ファイル】ラジオボタンでの表示を希望しない場合はこのファイルは削除してOKです。（vote.phpを使ッテ下さい）
//----------------------------------------------------------------------
...
<li>
<label for="vote<?php echo $i;?>" style="display:block">
<input type="radio" name="data[vote]" value="<?php echo $i;?>" id="vote<?php echo $i;?>" />
</label>
