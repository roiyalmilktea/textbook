...
<head>
    ...
    <body>
        レシピの投稿<br>
        <form method="post" enctype="multipart/form-data" action="/wordpress/update_recipe/">
            <input type="hidden" name="id" value="<?php echo htmlspecialchars($result['id'], ENT_QUOTES, 'UTF-8'); ?>">

            料理名:
            <input type="text" name="recipe_name" value="<?php echo htmlspecialchars($result['recipe_name'],ENT_QUOTES, 'UTF-8'); ?>">
            <br>
            ...
            予算:
            <input type="number" min="1" max="9999" name="budget" value="<?php echo htmlspecialchars($result['budget'], ENT_QUOTES, 'UTF-8'); ?>">円
            <br>
        ...
        <br><a href='/wordpress/index_recipe/'>トップページに戻る</a>
    </body>
</head>
</html>