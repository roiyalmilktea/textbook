...
<form action="<?php print $_SERVER['PHP_SELF']; ?>" id="formMain" name="formMain" method="POST">
  ...
  <h3>タイトル</h3>
  <p>
    <input name="subject" type="text"  class="form-control" id="subject" value="<?php print $row_Recordset1['subject']; ?>" size="50" maxlength="255" />
  </p>
  </div>
  <div class="form-group">
  <h3>内容</h3>
  <p>
    <textarea name="digest" class="form-control" cols="50" rows="5" id="digest"><?php print $row_Recordset1['digest']; ?></textarea>
  </p>
  </div>
  <div class="form-group">
  <h3>続き</h3>
  <p>
    <textarea name="document" class="form-control" cols="50" rows="20" id="document"><?php print $row_Recordset1['document']; ?></textarea>
  </p>
  </div>
  <p>
